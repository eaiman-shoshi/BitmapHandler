...
public abstract class ImageWorker {
     ...
     */
    public void loadImage(Object data, ImageView imageView, File myID3) {
        if (data == null) {
            return;
        }
        ...
        if (value != null) {
            ...
            getDrawable(value, String.valueOf(data));
        } else if (cancelPotentialWork(data, imageView)) {
            final BitmapWorkerTask task = new BitmapWorkerTask(imageView, myID3);
     ...
     */
    protected abstract Bitmap processBitmap(Object data, File file);
    
    protected abstract void getDrawable(Drawable drawable, Object name);
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, BitmapDrawable> {
        ...
        public BitmapWorkerTask(ImageView imageView, File myID3) {
        ...
        protected BitmapDrawable doInBackground(Object... params) {
            ...
            if (bitmap == null && !isCancelled() && getAttachedImageView() != null
                    && !mExitTasksEarly) {
                bitmap = processBitmap(params[0], myID3);
            }
